...
export async function getSession() {
  try {
    ...
    }>("cclms.api.portal.get_portal_config", undefined, { mutation: false }).catch(() => null);
    ...
    return {
      ...
      dashboard_method: portalConfig?.dashboard_method || "cclms.api.portal.get_dashboard",
...
export async function getBranding() {
  try {
    ...
    }>("cclms.api.portal.get_portal_config", undefined, { mutation: false });
